 ...
 *
 */
@OpenAPIDefinition(info = @Info(title = "Species Module MicroServices", version = "1.0.0", description = "API for Species Module"), servers = {
		@Server(url = "http://localhost:8080/species-api/api") })
