 ...
 *
 */
public class SpeciesServeletContextListener extends GuiceServletContextListener {

	private static final Logger logger = LoggerFactory.getLogger(SpeciesServeletContextListener.class);
...
//				of a single Channel being shared/injected everywhere.
				...
				try {
					...
					logger.error("[biodiv-species] Failed to establish RabbitMQ connection", e);
				}
