...
//	Traits and facts filter
	...
	TRAITS_RANGE_MAX("facts.range.max"), TRAITS_RANGE_MIN("facts.range.min"), TRAITS_COLOR_GROUP("facts.color.1"),
	TRAITS_RANGE_GROUP("facts.range.1"), TRAITS_COLOR_NAMEID("facts.color.nameId"),
